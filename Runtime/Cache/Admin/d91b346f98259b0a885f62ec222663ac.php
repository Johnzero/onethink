						...
						<form action="" method="post">
							<table border="0" width="100%">
								<tr>
									...
									<td width="5%"><?php echo ($list["name"]); ?> </td>
									<td width="15%">
										<?php echo ($list["title"]); ?>
									</td>
									<td width="5%"><?php echo ($list["tel"]); ?></td>
									<td width="10%"><?php echo ($list["sfz"]); ?></td>
									<td width="15%"><?php echo ($list["email"]); ?></td>
									<td width="15%"><?php echo ($list["content"]); ?></td>
									<td width="15%"><?php echo ($list["create_time"]); ?></td>
									<td width="25%">
