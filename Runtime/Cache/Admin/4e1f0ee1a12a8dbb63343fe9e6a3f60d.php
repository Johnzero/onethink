...
<body>
    ...
    <form method="post" class="form-horizontal">
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="username" value="<?php echo ($data["nickname"]); ?>">
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
            <select name="pid">
                <option selected> 主用户 </option>
                <?php if(is_array($parents)): $i = 0; $__LIST__ = $parents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["uid"]); ?>" <?php if(($data["pid"]) == $vo["uid"]): ?>selected<?php endif; ?> ><?php echo ($vo["nickname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
            </div>
        </div>
        ...
        <div class="form-item">
            <label class="item-label">密码
                ...
                （用户密码不能少于6位）
                <?php if((ACTION_NAME) == "edit"): ?>留空则不修改<?php endif; ?>
                </span>
            </label>
            <div class="controls">
