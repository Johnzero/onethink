...
<script>
	...
	<div class="main-title cf">
		<h2>
			校验编辑<?php echo (get_document_model($data["model_id"],'title')); ?> [
...
<div class="tab-wrap">
	...
	<!-- 表单 -->
	<form id="form" action="<?php echo U('jiaoyan_update');?>" method="post" class="form-horizontal">
		<!-- 基础文档模型 -->
		...
		<div class="form-item cf">
			<button class="btn submit-btn ajax-post hidden" id="submit" type="submit" target-form="form-horizontal">校验通过</button>
